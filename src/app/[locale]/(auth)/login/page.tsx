  ...
  return (
    <>
      ...
      <div className="fixed w-dvw h-dvh flex justify-center items-center top-0 left-0 z-20">
        <div
          className="border border-mainBorder/40 w-dvw h-dvh sm:w-auto sm:h-auto glass-card px-[6vw] xsm:px-[18vw] sm:px-12 pt-12 sm:pt-18 pb-12 flex flex-col items-center justify-start sm:rounded-2xl relative overflow-visible"
