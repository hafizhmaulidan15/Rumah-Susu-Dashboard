...
export const MenuCategory = ({ title }: MenuCategoryProps) => {
  ...
  return (
    <div
      className={`uppercase text-secondaryText pl-2 text-xs xl:text-xs 3xl:text-xs mt-6 1xl:mt-6 2xl:mt-6 mb-[0.6rem] 3xl:mb-3 whitespace-nowrap overflow-hidden transition-opacity duration-200 ${
